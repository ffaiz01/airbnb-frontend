...
import { PlayCircle, ExternalLink, ChevronDown, Pencil, Trash2, Check, X, Clock } from "lucide-react";
...
export const SearchBlock = ({ id, name, url, cleaningFee, lastRun, status = 'idle', pricingData, isCollapsed = false, onToggleCollapse, onUpdate, onDelete, onRun, onSchedule }: SearchBlockProps) => {
